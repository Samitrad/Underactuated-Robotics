...
def main():
    ...
    # =============================================================
    # RESTORED OLD CAMERA POSITION (ZOOMED IN / VECTOR BASED)
    # =============================================================
    ...
    params = {
        "m": 0.5, "l": 0.3,
        "I_eff": 0.05, 
        "I_w": 0.03,   # STABILITY FIX: High Inertia
        "b_p": 0.001,  # STABILITY FIX: Low Friction
        "b_w": 0.005,
        "g": 9.81,
    }
    ...
    print("Simulating RWIP (Stable + Original Camera)...")
    sim.AdvanceTo(30.0)
